...
## 요약
 1. 현대 사회에서는 "ICBM" Iot Cloud BigData Mobile 을 근간으로한 4차 산업 혁명 시대에 도달했다. 이로인해 전 분야에<br/>
    ICT 기술을 융합하여 새롭고 다양한 시장을 창출하고있는 상황이다.<br/>
    이에 따라 전 분야에 ICT 기술을 응용 , 활용할수있는 능력이 대두되고있다.<br/>
    본 연구는 다양한 산업 중 농 축산 산업에 ICT 기술을 접목시켜 농업의 자동화 시스템을 구축함으로써<br/>
    ICT 기술로 인해 보다 효율적인 농업의 자동화 시스템을 진행할수있는 방안을 마련하였다<br/>
## 서론
 1. 내용 추가 예정
